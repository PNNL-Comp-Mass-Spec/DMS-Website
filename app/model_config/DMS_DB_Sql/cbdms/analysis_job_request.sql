...
INSERT INTO "form_fields" VALUES(4,'AJR_datasets','Datasets','area','','','12','80','','trim|required');
...
INSERT INTO "form_fields" VALUES(8,'AJR_organismName','Organism','text','60','128','','','','trim|required|max_length[128]');
INSERT INTO "form_fields" VALUES(9,'protCollNameList','Protein Collection List','area','','','3','60','','trim|max_length[4000]');
INSERT INTO "form_fields" VALUES(10,'protCollOptionsList','Protein Options List','area','','','2','40','seq_direction=forward','trim|max_length[256]');
INSERT INTO "form_fields" VALUES(11,'AJR_organismDBName','Legacy Fasta (typically na)','text','100','128','','','','trim|max_length[128]');
INSERT INTO "form_fields" VALUES(12,'requestor','Requested by (PRN)','text','40','80','','','','trim|required|max_length[32]');
INSERT INTO "form_fields" VALUES(14,'State','State','text','24','24','','','New','trim|required|max_length[24]');
INSERT INTO "form_fields" VALUES(15,'AJR_comment','Comment','area','','','4','50','','trim|max_length[512]');
INSERT INTO "form_fields" VALUES(16,'AJR_specialProcessing','Special Processing','area','','','4','80','','trim|max_length[512]');
...
INSERT INTO "sproc_args" VALUES(15,'State','state','varchar','input','32','AddUpdateAnalysisJobRequest');
INSERT INTO "sproc_args" VALUES(16,'AJR_requestID','requestID','int','output','','AddUpdateAnalysisJobRequest');
INSERT INTO "sproc_args" VALUES(17,'<local>','mode','varchar','input','12','AddUpdateAnalysisJobRequest');
INSERT INTO "sproc_args" VALUES(18,'<local>','message','varchar','output','512','AddUpdateAnalysisJobRequest');
INSERT INTO "sproc_args" VALUES(19,'<local>','callingUser','varchar','input','128','AddUpdateAnalysisJobRequest');
INSERT INTO "sproc_args" VALUES(20,'ID','request','varchar','input','32','DoAnalysisRequestOperation');
INSERT INTO "sproc_args" VALUES(21,'<local>','mode','varchar','input','12','DoAnalysisRequestOperation');
INSERT INTO "sproc_args" VALUES(22,'<local>','message','varchar','output','512','DoAnalysisRequestOperation');
COMMIT;

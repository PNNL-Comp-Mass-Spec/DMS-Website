...
<script src="<?= base_url('javascript/jquery/jquery-3.7.1.min.js') ?>"></script>
<script src="<?= base_url('javascript/jquery/jquery-migrate-3.5.0.min.js') ?>"></script>
<script src="<?= base_url('javascript/jquery-ui-1.14.1/jquery-ui.min.js') ?>"></script>
...
<script src="<?= base_url('javascript/dms.js?version=2') ?>"></script>
...
<script src="<?= base_url('javascript/dmsNav.js?version=3') ?>"></script>
<script src="<?= base_url('javascript/dmsOps.js?version=4') ?>"></script>

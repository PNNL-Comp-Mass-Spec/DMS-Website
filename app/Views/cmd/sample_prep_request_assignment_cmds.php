...
<span><?= $choosers->get_chooser('state', 'sampleRequestStatePickList')?></span>
</div>
...
<!-- <span><?= $choosers->get_chooser('cmp_date_fld', 'futureDatePickList')?></span> -->
</div>
...
<span style="display:block" ><?= $choosers->get_chooser('user_list_fld', 'samplePrepUserPickList', 'append-comma')?>(select user to add to list)</span>
</div>

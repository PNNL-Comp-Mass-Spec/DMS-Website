...
<div>
<!--
  lcmdExtras.requested_run_admin.setRequestStatus is defined in lcmdExtras.js
...
<input class='button lst_cmd_btn' type="button" value="Unassign Requests"
       onClick='lcmdExtras.requested_run_admin.setRequestStatus("UnassignInstrument")'
...
<input class='button lst_cmd_btn' type="button" value="Set Requests Active"
       onClick='lcmdExtras.requested_run_admin.setRequestStatus("Active")'
...
<input class='button lst_cmd_btn' type="button" value="Set Requests Inactive"
       onClick='lcmdExtras.requested_run_admin.setRequestStatus("Inactive")'
...
<input class='button lst_cmd_btn' type="button" value="Place Requests On Hold"
       onClick='lcmdExtras.requested_run_admin.setRequestStatus("Holding")'
...
<div>
<!--
    lcmdExtras.requested_run_admin.changeWPN is defined in lcmdExtras.js
...
<input class='button lst_cmd_btn' type="button" value="Change WPN"
       onClick='lcmdExtras.requested_run_admin.changeWPN($("#oldWPN").val(), $("#newWPN").val())'
...
<input class='button lst_cmd_btn' type="button" value="Delete Requests"
       onClick='lcmdExtras.requested_run_admin.setRequestStatus("Delete")'

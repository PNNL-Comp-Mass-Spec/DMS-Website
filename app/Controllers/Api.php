...
class Api extends BaseController
{
    public function index()
    {
        ...
        $apiCalls = [
            ...
            'POST api/[entity_type]/create' => 'Create a new entity with JSON data in POST data',
            'GET api/[entity_type]/[id]/edit' => 'Get JSON data/fields with current data for editing',
            'PUT/PATCH/POST api/[entity_type]/[id]/update' => 'Update entity with JSON in data. Requires full set of JSON fields from /edit',

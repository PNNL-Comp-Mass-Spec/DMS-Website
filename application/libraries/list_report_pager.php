...
class List_report_pager {
	...
	private $cur_row_function	= 'kappa.setListReportCurRow'; // Javascript function that sets current row
	...
	function create_stats()
	{
		...
		//
		$page_sizer = '<a href="javascript:kappa.setPageSize('.$this->per_page.', '.$this->total_rows.','.$mrr.')" title="Click to change setting for number of rows on a page">Set Rows</a>';
		$show_all = '<a href="javascript:kappa.setPageSize(\'all\', '.$this->total_rows.','.$mrr.')" title="Click to show maximum allowed number of rows ('.$mrr.') on the page">Max Rows</a>';

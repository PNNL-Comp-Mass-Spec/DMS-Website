...
INSERT INTO "form_fields" VALUES(4,'SiteStatus','Site Status','text','32','32','','','','trim|required|max_length[32]');
CREATE TABLE form_field_choosers ( id INTEGER PRIMARY KEY,  "field" text, "type" text, "PickListName" text, "Target" text, "XRef" text, "Delimiter" text, "Label" text);
INSERT INTO "form_field_choosers" VALUES(1,'SiteStatus','picker.replace','EUSUserSiteStatusPickList','','',',','');
...
INSERT INTO "sproc_args" VALUES(3,'SiteStatus','EUSSiteStatus','varchar','input','32','AddUpdateEUSUsers');

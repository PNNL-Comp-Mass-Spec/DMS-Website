...
INSERT INTO "form_fields" VALUES(3,'researcherPRN','Researcher (PRN)','text','40','80','','','','trim|required|max_length[50]');
INSERT INTO "form_fields" VALUES(4,'organismName','Organism Name','text','40','80','','','','trim|required|max_length[128]');
...
INSERT INTO "form_fields" VALUES(9,'sampleConcentration','Smpl. Concentration','text','40','80','','','','trim|required|max_length[32]');
INSERT INTO "form_fields" VALUES(10,'enzymeName','Digestion Enzyme','text','40','50','','','Trypsin','trim|required|max_length[50]');
INSERT INTO "form_fields" VALUES(11,'labNotebookRef','Lab Notebook','text','40','80','','','','trim|required|max_length[128]');
...
INSERT INTO "sproc_args" VALUES(8,'organismName','organismName','varchar','input','128','AddUpdateExperiment');
...
INSERT INTO "sproc_args" VALUES(13,'labNotebookRef','labNotebookRef','varchar','input','128','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(14,'labelling','labelling','varchar','input','64','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(15,'cellCultureList','cellCultureList','varchar','input','2048','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(16,'referenceCompoundList','referenceCompoundList','varchar','input','2048','AddUpdateExperiment');
...
INSERT INTO "sproc_args" VALUES(23,'ID','experimentId','int','output','','AddUpdateExperiment');

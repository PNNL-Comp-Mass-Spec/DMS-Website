...
INSERT INTO "general_params" VALUES('list_report_data_cols','''x'' AS Sel, [Payroll Num], Name + '' ('' + [Payroll Num] + '')'' AS Name');
INSERT INTO "general_params" VALUES('list_report_helper_multiple_selection','yes');
CREATE TABLE list_report_primary_filter ( id INTEGER PRIMARY KEY,  "name" text, "label" text, "size" text, "value" text, "col" text, "cmp" text, "type" text, "maxlength" text, "rows" text, "cols" text );
INSERT INTO "list_report_primary_filter" VALUES(1,'pf_payroll_num','Payroll Num','32','','Payroll Num','ContainsText','text','128','','');

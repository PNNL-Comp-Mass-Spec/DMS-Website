...
INSERT INTO "general_params" VALUES('list_report_data_cols','[ID],[Dataset],[Experiment],[Campaign],[Instrument],[Created],[Comment],[Rating],[Dataset Type],[Operator],[Dataset Folder Path],[QC_Link],[Acq Start],[Acq. End],[Acq Length],[Scan Count],[File Size MB],[LC Column],[Separation Type],[Request],[Requester]');
...
INSERT INTO "form_fields" VALUES(6,'LC_Cart_Config','LC Cart Config','hidden','','','','','','');
INSERT INTO "form_fields" VALUES(7,'DS_Column','LC Column','text','40','50','','','','trim|max_length[64]');
INSERT INTO "form_fields" VALUES(8,'DS_wellplate_num','Wellplate Number','hidden','','','','','','');
INSERT INTO "form_fields" VALUES(9,'DS_well_num','Well Number','hidden','','','','','','');
...
INSERT INTO "form_fields" VALUES(15,'DS_EUSUsageType','EMSL Usage Type','hidden','','','','','(ignore)','');
INSERT INTO "form_fields" VALUES(16,'DS_EUSProposalID','EMSL Proposal ID','hidden','','','','','(ignore)','');
INSERT INTO "form_fields" VALUES(17,'DS_EUSUsers','EMSL Users List','hidden','','','','','(ignore)','');

...
INSERT INTO "table_edit_col_defs" VALUES(10,'list_report_hotlinks','LinkType','literal_list','{"list":["invoke_entity","CHECKBOX","color_label","column_tooltip","copy_color_from","format_commas","format_date","href-folder","image_link","inplace_edit","invoke_multi_col","link_list","literal_link","markup","masked_href-folder","masked_link", "min_col_width", "row_to_json","row_to_url","select_case","update_opener"]}');

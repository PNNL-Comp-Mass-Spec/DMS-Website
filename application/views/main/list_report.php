...
<a href="javascript:void(0)" onclick="Effect.toggle('primary_filter_container', 'appear', { duration: 0.1 }); return false;">Primary</a> &nbsp;
<a href="javascript:void(0)" onclick="Effect.toggle('secondary_filter_container', 'appear', { duration: 0.1 }); return false;">Secondary</a> &nbsp;

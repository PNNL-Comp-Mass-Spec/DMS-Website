...
<div class='item' ><a  class='button my_link' href='<?= site_url() ?>grid/factors' >Factors</a></div><div class='item' ><a  class='button my_link' href='<?= site_url() ?>grid/instrument_usage' >Instrument Usage EMSL Updates</a></div>

...
Import/Export Delimited Text <a href="javascript:void(0)" title="Click to hide or show delimited text control panel" onclick="gamma.sectionToggle('delimited_text_panel', 0.5, this)"><span class="expando_section ui-icon ui-icon-circle-plus"></span></a>
</div>

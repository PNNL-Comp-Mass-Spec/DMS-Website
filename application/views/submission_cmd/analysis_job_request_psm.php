...
<div class="EPagCmds" style="clear:both;display:none;" id="sub_cmd_buttons">
    <button name='create_request_btn' onclick='entry.analysis_job_request_psm.createRequest()' class='button'>Create Job Request</button>
    <button name='create_preview_btn' onclick='entry.analysis_job_request_psm.previewRequest()' class='button'>Preview Job Request</button>

...
<hr>
<a href="#" onclick="sectionToggle('upload_section', 0.5)">Upload allocations...</a>
...
<hr>
<a href="#" onclick="sectionToggle('move_cmd_section', 0.5)">Move allocation...</a>
...
<hr>
<a href="#" onclick="sectionToggle('set_cmd_section', 0.5)">Set allocation...</a>

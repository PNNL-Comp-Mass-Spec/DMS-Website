...
<hr>
Move allocation <a href="javascript:void(0)" onclick="gamma.sectionToggle('move_cmd_section', 0.5, this)"><span class="expando_section ui-icon ui-icon-circle-plus"></span></a>
...
<hr>
Set allocation <a href="javascript:void(0)" onclick="gamma.sectionToggle('set_cmd_section', 0.5, this)"><span class="expando_section ui-icon ui-icon-circle-plus"></span></a>

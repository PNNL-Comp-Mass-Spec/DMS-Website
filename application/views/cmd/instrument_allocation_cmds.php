...
<hr>
Upload allocations <a href="javascript:void(0)" onclick="gamma.sectionToggle('upload_section', 0.5, this)"><?= expansion_link() ?></a>
...
<hr>
Move allocation <a href="javascript:void(0)" onclick="gamma.sectionToggle('move_cmd_section', 0.5, this)"><?= expansion_link() ?></a>
...
<hr>
Set allocation <a href="javascript:void(0)" onclick="gamma.sectionToggle('set_cmd_section', 0.5, this)"><?= expansion_link() ?></a>

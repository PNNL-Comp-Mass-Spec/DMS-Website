...
Set Membership Enabled <a title="Show or hide the controls to set processor membership enabled" href="javascript:void(0)" onclick="gamma.sectionToggle('setMembershipSection', 0.5, this)"><?= expansion_link_icon() ?></a>
...
Remove Processors <a title="Show or hide the controls to remove processors from group" href="javascript:void(0)" onclick="gamma.sectionToggle('removeProcessorsSection', 0.5, this)"><?= expansion_link_icon() ?></a>
...
Add Processors <a title="Show or hide the controls to add new processors to group" href="javascript:void(0)" onclick="gamma.sectionToggle('addProcessorsSection', 0.5, this)"><?= expansion_link_icon() ?></a>

...
<div>
<span><input class="lst_cmd_btn" type="button" value="Update" onClick='lcmd.material_move_items.op("retire_items", "mixed_material")' /></span>
<span>Retire selected material items 
</span>
</div>

<div>
<span><input class="lst_cmd_btn" type="button" value="Update" onClick='lcmd.material_move_items.op("move_material", "mixed_material", "container_fld")' /></span>

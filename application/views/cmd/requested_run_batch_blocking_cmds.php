...
<hr>
Blocking commands <a href="javascript:void(0)" onclick="gamma.toggleVisibility('blocking_section', 0.5, this)"><?= expansion_link_icon() ?></a>
...
<hr>
Batch commands <a href="javascript:void(0)" onclick="gamma.toggleVisibility('batch_section', 0.5, this)"><?= expansion_link_icon() ?></a>

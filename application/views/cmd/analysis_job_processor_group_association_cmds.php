...
Remove jobs from association <a title="Show or hide the controls to disassociate jobs from group" href="javascript:void(0)" onclick="gamma.toggleVisibility('removeJobsSection', 0.5, this)"><?= expansion_link_icon() ?></a>
...
Add New Jobs <a title="Show or hide the controls to associate new jobs with group" href="javascript:void(0)" onclick="gamma.toggleVisibility('addNewJobsSection', 0.5, this)"><?= expansion_link_icon() ?></a>

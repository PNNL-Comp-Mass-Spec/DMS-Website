...
<div>
<span><input class="lst_cmd_btn" type="button" value="Update" onClick='lcmd.material_move_container.op("retire_container")' /></span>
<span>Retire selected containers (must be empty)
</span>
</div>

<div>
<span><input class="lst_cmd_btn" type="button" value="Update" onClick='lcmd.material_move_container.op("retire_container_and_contents")' /></span>
<span>Retire selected containers (and their contents)
</span>
</div>

<div>
<span><input class="lst_cmd_btn" type="button" value="Update" onClick='lcmd.material_move_container.op("move_container", "location_fld")' /></span>

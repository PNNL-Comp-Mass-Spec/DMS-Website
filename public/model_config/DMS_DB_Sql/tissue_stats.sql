...
INSERT INTO general_params VALUES('list_report_sproc','report_tissue_usage_stats_proc');
CREATE TABLE sproc_args ( id INTEGER PRIMARY KEY, "field" text, "name" text, "type" text, "dir" text, "size" text, "procedure" text);
INSERT INTO sproc_args VALUES(1,'start_date','startDate','varchar','input','24','report_tissue_usage_stats_proc');
INSERT INTO sproc_args VALUES(2,'end_date','endDate','varchar','input','24','report_tissue_usage_stats_proc');
INSERT INTO sproc_args VALUES(3,'organism_id_filter_list','organismIDFilterList','varchar','input','2000','report_tissue_usage_stats_proc');
INSERT INTO sproc_args VALUES(4,'campaign_id_filter_list','campaignIDFilterList','varchar','input','2000','report_tissue_usage_stats_proc');
INSERT INTO sproc_args VALUES(5,'instrument_filter_list','instrumentFilterList','varchar','input','2000','report_tissue_usage_stats_proc');
INSERT INTO sproc_args VALUES(6,'<local>','message','varchar','output','256','report_tissue_usage_stats_proc');

...
INSERT INTO utility_queries VALUES(4,'dsj','Test Case 3','package','check_data_package_dataset_job_coverage(id, tool, mode)','*','','{"id":"Rp", "tool":"Rp", "mode":"Rp"}','');
INSERT INTO utility_queries VALUES(5,'job_parm','Test Case 4','broker','get_job_parameters(job)','*','','{"job":"Rp"}','');
...
INSERT INTO utility_queries VALUES(10,'aux_info','Aux Info Details','','V_Aux_Info_Definition_With_ID_And_Allowed_Values','*','{"col":"target", "dir":"ASC"}','{"target":"CTx", "category":"CTx", "subcategory":"CTx", "item":"CTx"}','');
...
INSERT INTO utility_queries VALUES(13,'instrument_run_info','Instrument Run Information','','get_instrument_run_datasets(mostRecentWeeks, instrument)','*','','{"mostRecentWeeks":"Rp", "instrument":"Rp"}','');
...
INSERT INTO utility_queries VALUES(17,'capture_operations','Capture Task Operations','capture','V_Task_Steps WHERE State IN (4, 6)','*','{"col":"job", "dir":"DESC"}','{"job":"EQn", "dataset":"CTx"}','');
INSERT INTO utility_queries VALUES(18,'job_operations','Analysis Job Operations','broker','V_Job_Steps2 WHERE State IN (4, 6)','*','{"col":"job", "dir":"DESC"}','{"job":"EQn", "dataset":"CTx"}','');
...
INSERT INTO utility_queries VALUES(24,'dms_emsl_inst','DMS To EMSL Instrument Mapping','','V_EMSL_Instruments',replace(replace('Instrument as DMS_Instrument_Name,\r\nEUS_Instrument_Name, \r\nEUS_Display_Name, \r\nLocal_Category_Name','\r',char(13)),'\n',char(10)),'',replace(replace('{ "DMS_Instrument_Name":"CTx",\r\n"EUS_Instrument_Name":"CTx", "EUS_Display_Name":"CTx", "Local_Category_Name":"CTx" }','\r',char(13)),'\n',char(10)),'');
...
INSERT INTO utility_queries VALUES(29,'data_package_datasets','Data Package Datasets','','V_Data_Package_Datasets_Export','Dataset as id','{"col":"id", "dir":"ASC"}','{"Data_Package_ID":"EQn"}','');
INSERT INTO utility_queries VALUES(30,'batch_requests','Batch Requests','','V_Requested_Run_Export','Request_ID as id','{"col":"Request_ID", "dir":"ASC"}','{"Batch_ID":"EQn"}','');
INSERT INTO utility_queries VALUES(31,'data_package_list','Data Package List','package','(SELECT label, value FROM V_Data_Package_Label_Value_Picklist) TX','*','','{"label":"CTx"}','');
INSERT INTO utility_queries VALUES(32,'osm_package_list','OSM Package List','package','(SELECT label, value FROM V_OSM_Package_Label_Value_Picklist) TX','*','','{"label":"CTx"}','');

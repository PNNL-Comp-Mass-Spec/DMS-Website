...
INSERT INTO general_params VALUES('entry_sproc','add_update_reference_compound');
...
INSERT INTO sproc_args VALUES(1,'compound_id','compoundID','int','input','12','add_update_reference_compound');
INSERT INTO sproc_args VALUES(2,'compound_name','compoundName','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(3,'description','description','varchar','input','500','add_update_reference_compound');
INSERT INTO sproc_args VALUES(4,'compound_type_name','compoundTypeName','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(5,'gene_name','geneName','varchar','input','128','add_update_reference_compound');
INSERT INTO sproc_args VALUES(7,'modifications','modifications','varchar','input','500','add_update_reference_compound');
INSERT INTO sproc_args VALUES(8,'organism_name','organismName','varchar','input','128','add_update_reference_compound');
INSERT INTO sproc_args VALUES(9,'pub_chem_cid','pubChemID','varchar','input','12','add_update_reference_compound');
INSERT INTO sproc_args VALUES(10,'campaign','campaignName','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(11,'container','containerName','varchar','input','128','add_update_reference_compound');
INSERT INTO sproc_args VALUES(12,'wellplate_name','wellplateName','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(13,'well_number','wellNumber','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(14,'contact_username','contactUsername','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(15,'supplier','supplier','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(16,'product_id','productId','varchar','input','128','add_update_reference_compound');
INSERT INTO sproc_args VALUES(17,'purchase_date','purchaseDate','varchar','input','30','add_update_reference_compound');
INSERT INTO sproc_args VALUES(18,'purity','purity','varchar','input','64','add_update_reference_compound');
INSERT INTO sproc_args VALUES(19,'purchase_quantity','purchaseQuantity','varchar','input','128','add_update_reference_compound');
INSERT INTO sproc_args VALUES(20,'mass','mass','varchar','input','30','add_update_reference_compound');
INSERT INTO sproc_args VALUES(21,'active','active','varchar','input','3','add_update_reference_compound');
INSERT INTO sproc_args VALUES(22,'<local>','mode','varchar','input','12','add_update_reference_compound');
INSERT INTO sproc_args VALUES(23,'<local>','message','varchar','output','512','add_update_reference_compound');
INSERT INTO sproc_args VALUES(24,'<local>','callingUser','varchar','input','128','add_update_reference_compound');
...
INSERT INTO form_field_choosers VALUES(1,'contact_username','picker.replace','userUsernamePickList','','',',','');

...
INSERT INTO general_params VALUES('entry_sproc','add_update_requested_run_batch');
...
INSERT INTO general_params VALUES('operations_sproc','do_requested_run_batch_operation');
...
INSERT INTO form_fields VALUES(1,'id','ID','non-edit','','','','','','trim|max_length[12]');
...
INSERT INTO sproc_args VALUES(1,'id','id','int','output','','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(2,'name','name','varchar','input','50','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(3,'description','description','varchar','input','256','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(4,'requested_run_list','requestedRunList','text','input','2147483647','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(5,'owner_username','ownerUsername','varchar','input','24','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(6,'requested_batch_priority','requestedBatchPriority','varchar','input','24','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(7,'requested_completion_date','requestedCompletionDate','varchar','input','32','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(8,'justification_high_priority','justificationHighPriority','varchar','input','512','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(9,'requested_instrument_group','requestedInstrumentGroup','varchar','input','64','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(10,'comment','comment','varchar','input','512','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(11,'batch_group','batchGroupID','int','input','24','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(12,'batch_group_order','batchGroupOrder','int','input','12','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(13,'<local>','mode','varchar','input','12','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(14,'<local>','message','varchar','output','512','add_update_requested_run_batch');
INSERT INTO sproc_args VALUES(15,'id','batchID','int','input','','do_requested_run_batch_operation');
INSERT INTO sproc_args VALUES(16,'<local>','mode','varchar','input','12','do_requested_run_batch_operation');
INSERT INTO sproc_args VALUES(17,'<local>','message','varchar','output','512','do_requested_run_batch_operation');
COMMIT;

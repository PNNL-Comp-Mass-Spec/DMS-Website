...
INSERT INTO "form_fields" VALUES(13,'rating','Interest Rating','text','25','80','','','Unreviewed','trim|default_value[Unknown]|required|max_length[32]');
INSERT INTO "form_fields" VALUES(14,'request','Request','text','12','24','','','0','trim|required');
...
INSERT INTO "form_field_choosers" VALUES(9,'rating','picker.replace','datasetRatingPickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(10,'request','list-report.helper','','helper_scheduled_run/report','',',','');
...
INSERT INTO "list_report_hotlinks" VALUES(6,'ID','export_align','value','','{"Align":"Center"}');
INSERT INTO "list_report_hotlinks" VALUES(7,'Acq Length','export_align','value','','{"Align":"Center"}');
INSERT INTO "list_report_hotlinks" VALUES(8,'Scan Count','export_align','value','','{"Align":"Center"}');
...
INSERT INTO "external_sources" VALUES(4,'requested_run','separation_type','ColName','Separation Group');
...
INSERT INTO "external_sources" VALUES(10,'requested_run','rating','Literal','Unknown');
INSERT INTO "external_sources" VALUES(11,'requested_run','request','ColName','Request');
...
INSERT INTO "external_sources" VALUES(16,'prep_lc_run','rating','Literal','Released');
...
INSERT INTO "sproc_args" VALUES(12,'rating','rating','varchar','input','32','AddUpdateDataset');
...
INSERT INTO "sproc_args" VALUES(17,'request','requestID','int','input','','AddUpdateDataset');

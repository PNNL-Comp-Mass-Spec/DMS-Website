...
INSERT INTO sproc_args VALUES(1,'script','Script','varchar','input','64','add_update_scripts');
INSERT INTO sproc_args VALUES(2,'description','Description','varchar','input','2000','add_update_scripts');
INSERT INTO sproc_args VALUES(3,'enabled','Enabled','char','input','1','add_update_scripts');
INSERT INTO sproc_args VALUES(4,'results_tag','ResultsTag','varchar','input','8','add_update_scripts');
INSERT INTO sproc_args VALUES(5,'backfill_to_dms','BackfillToDMS','varchar','input','1','add_update_scripts');
INSERT INTO sproc_args VALUES(6,'contents','Contents','text','input','2147483647','add_update_scripts');
INSERT INTO sproc_args VALUES(7,'parameters','Parameters','text','input','2147483647','add_update_scripts');
INSERT INTO sproc_args VALUES(8,'fields','Fields','text','input','2147483647','add_update_scripts');
INSERT INTO sproc_args VALUES(9,'<local>','mode','varchar','input','12','add_update_scripts');
INSERT INTO sproc_args VALUES(10,'<local>','message','varchar','output','512','add_update_scripts');
INSERT INTO sproc_args VALUES(11,'<local>','callingUser','varchar','input','128','add_update_scripts');
...
INSERT INTO utility_queries VALUES(1,'dot','broker','v_pipeline_scripts','*','{"script":"MTx"}');
COMMIT;

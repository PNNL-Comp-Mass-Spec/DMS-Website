...
INSERT INTO sproc_args VALUES(3,'itemType','itemType','varchar','input','128','update_material_items');
INSERT INTO sproc_args VALUES(4,'newValue','newValue','varchar','input','128','update_material_items');
INSERT INTO sproc_args VALUES(5,'comment','comment','varchar','input','512','update_material_items');
INSERT INTO sproc_args VALUES(6,'<local>','message','varchar','output','512','update_material_items');
INSERT INTO sproc_args VALUES(7,'<local>','callingUser','varchar','input','128','update_material_items');
COMMIT;

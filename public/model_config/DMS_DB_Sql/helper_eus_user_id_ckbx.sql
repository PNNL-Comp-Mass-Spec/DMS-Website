...
INSERT INTO list_report_primary_filter VALUES(1,'pf_user_name','User Name','32','','User Name','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(2,'pf_site_status','Site Status','32','','Site Status','ContainsText','text','128','','');
CREATE TABLE list_report_hotlinks ( id INTEGER PRIMARY KEY,  "name" text, "LinkType" text, "WhichArg" text, "Target" text, "Options" text );
INSERT INTO list_report_hotlinks VALUES(1,'Sel','CHECKBOX','User ID','','');
INSERT INTO list_report_hotlinks VALUES(2,'User ID','update_opener','value','','');
COMMIT;

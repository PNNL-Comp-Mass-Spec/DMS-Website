...
INSERT INTO "general_params" VALUES('entry_page_data_id_col','wellplate_num');
...
INSERT INTO "general_params" VALUES('post_submission_detail_id','wellplate_num');
CREATE TABLE form_fields ( id INTEGER PRIMARY KEY, "name"  text, "label" text, "type" text, "size" text, "maxlength" text, "rows" text, "cols" text, "default" text, "rules" text);
INSERT INTO "form_fields" VALUES(1,'wellplate_num','Wellplate Number','text','50','64','','','(generate name)','trim|max_length[64]');
...
INSERT INTO "sproc_args" VALUES(1,'wellplate_num','wellplateNum','varchar','output','64','AddUpdateWellplate');

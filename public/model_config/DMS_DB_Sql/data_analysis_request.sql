...
INSERT INTO general_params VALUES('entry_sproc','add_update_data_analysis_request');
...
INSERT INTO list_report_hotlinks VALUES(2,'analysis_type','invoke_entity','value','data_analysis_request/report/-/-/~','');
INSERT INTO list_report_hotlinks VALUES(4,'files','invoke_entity','id','file_attachment/report/-/StartsWith__data_analysis_request/@','');
...
INSERT INTO list_report_hotlinks VALUES(6,'work_package','invoke_entity','value','charge_code/show','');
...
INSERT INTO list_report_hotlinks VALUES(8,'state_comment','min_col_width','value','60','');
INSERT INTO list_report_hotlinks VALUES(9,'description','min_col_width','value','60','');
INSERT INTO list_report_hotlinks VALUES(10,'batch','invoke_entity','value','requested_run_batch/show','');
INSERT INTO list_report_hotlinks VALUES(11,'data_package','invoke_entity','value','data_package/show','');
INSERT INTO list_report_hotlinks VALUES(12,'exp_group','invoke_entity','value','experiment_group/show','');
INSERT INTO list_report_hotlinks VALUES(13,'eus_proposal','invoke_entity','value','eus_proposals/show','');
INSERT INTO list_report_hotlinks VALUES(14,'organism','invoke_entity','value','organism/report/~','');
INSERT INTO list_report_hotlinks VALUES(15,'campaign','invoke_entity','value','campaign/show','');
...
INSERT INTO list_report_hotlinks VALUES(18,'+id','export_align','value','','{"Align":"Center"}');
INSERT INTO list_report_hotlinks VALUES(19,'+dataset_count','export_align','value','','{"Align":"Center"}');
INSERT INTO list_report_hotlinks VALUES(20,'+days_in_queue','export_align','value','','{"Align":"Center"}');
INSERT INTO list_report_hotlinks VALUES(21,'+work_package','export_align','value','','{"Align":"Center"}');
INSERT INTO list_report_hotlinks VALUES(22,'+wp_state','export_align','value','','{"Align":"Center"}');
INSERT INTO list_report_hotlinks VALUES(23,'+eus_proposal','export_align','value','','{"Align":"Center"}');
...
INSERT INTO list_report_primary_filter VALUES(2,'pf_request_name','Request Name','30!','','request_name','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(3,'pf_type','Type','32','','analysis_type','ContainsText','text','32','','');
INSERT INTO list_report_primary_filter VALUES(4,'pf_id','ID','20','','id','Equals','text','32','','');
INSERT INTO list_report_primary_filter VALUES(5,'pf_requester','Requester','32','','requester','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(6,'pf_organism','Organism','32','','organism','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(7,'pf_campaign','Campaign','20','','campaign','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(8,'pf_WP','WP','32','','wp','ContainsText','text','50','','');
...
INSERT INTO detail_report_hotlinks VALUES(6,'data_package_ids','link_list','data_package_ids','data_package/show','valueCol','dl_Data_Packages','');
...
INSERT INTO sproc_args VALUES(1,'request_name','requestName','varchar','input','128','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(2,'analysis_type','analysisType','varchar','input','16','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(3,'requester_username','requesterUsername','varchar','input','32','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(4,'description','description','varchar','input','1024','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(5,'analysis_specifications','analysisSpecifications','varchar','input','2048','add_update_data_analysis_request');
...
INSERT INTO sproc_args VALUES(8,'data_package_ids','dataPackageIDs','varchar','input','1024','add_update_data_analysis_request');
...
INSERT INTO sproc_args VALUES(13,'priority','priority','varchar','input','12','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(14,'reason_for_high_priority','reasonForHighPriority','varchar','input','1024','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(15,'estimated_analysis_time_days','estimatedAnalysisTimeDays','int','input','','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(16,'state_name','state','varchar','input','32','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(17,'state_comment','stateComment','varchar','input','512','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(18,'id','id','int','output','','add_update_data_analysis_request');
INSERT INTO sproc_args VALUES(19,'<local>','mode','varchar','input','24','add_update_data_analysis_request');
...
INSERT INTO form_fields VALUES(9,'data_package_ids','Data Package IDs','area','','','2','60','','trim|max_length[1024]');
...
INSERT INTO form_field_choosers VALUES(4,'data_package_ids','list-report.helper','','helper_data_package_ckbx/report','data_package_ids',',','Choose from:');

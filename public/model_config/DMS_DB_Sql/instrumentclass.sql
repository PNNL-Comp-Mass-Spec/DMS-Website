...
INSERT INTO form_fields VALUES(2,'is_purgable','Is Purgable','text','1','1','','','','trim|required|max_length[1]');
INSERT INTO form_fields VALUES(3,'raw_data_type','Raw Data Type','text','32','32','','','','trim|required|max_length[32]');
INSERT INTO form_fields VALUES(4,'requires_preparation','Requires Preparation','text','1','1','','','','trim|required|max_length[1]');

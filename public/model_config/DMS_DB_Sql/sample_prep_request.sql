...
INSERT INTO list_report_primary_filter VALUES(2,'pf_requestname','Request Name','32','','RequestName','ContainsText','text','128','','');
...
INSERT INTO detail_report_hotlinks VALUES(21,'Work Package State','color_label','wp_activation_state','','valueCol','dl_Work_Package_State',replace('{"3":"clr_90","4":"clr_120",\n"5":"clr_120","10":"clr_120"}','\n',char(10)));
...
INSERT INTO sproc_args VALUES(6,'biohazard_level','biohazardLevel','varchar','input','12','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(7,'campaign','campaign','varchar','input','128','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(8,'number_of_samples','numberofSamples','int','input','','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(9,'sample_name_list','sampleNameList','varchar','input','1500','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(10,'sample_type','sampleType','varchar','input','128','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(11,'prep_method','prepMethod','varchar','input','512','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(12,'sample_naming_convention','sampleNamingConvention','varchar','input','128','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(13,'assigned_personnel','assignedPersonnel','varchar','input','256','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(14,'requested_personnel','requestedPersonnel','varchar','input','256','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(15,'estimated_prep_time_days','estimatedPrepTimeDays','int','input','','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(16,'estimated_ms_runs','estimatedMSRuns','varchar','input','16','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(17,'work_package','workPackageNumber','varchar','input','64','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(18,'eus_proposal_id','eusProposalID','varchar','input','10','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(19,'eus_usage_type','eusUsageType','varchar','input','50','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(20,'eus_user_id','eusUserID','int','input','','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(21,'instrument_group','instrumentGroup','varchar','input','128','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(22,'dataset_type','datasetType','varchar','input','50','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(23,'instrument_analysis_specifications','instrumentAnalysisSpecifications','varchar','input','512','AddUpdateSamplePrepRequest');
...
INSERT INTO sproc_args VALUES(27,'state_comment','stateComment','varchar','input','512','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(28,'id','id','int','output','','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(29,'separation_group','separationGroup','varchar','input','256','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(30,'block_and_randomize_samples','blockAndRandomizeSamples','char','input','3','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(31,'block_and_randomize_runs','blockAndRandomizeRuns','char','input','3','AddUpdateSamplePrepRequest');
INSERT INTO sproc_args VALUES(32,'reason_for_high_priority','reasonForHighPriority','varchar','input','1024','AddUpdateSamplePrepRequest');

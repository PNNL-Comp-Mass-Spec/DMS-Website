...
INSERT INTO sproc_args VALUES(3,'instrument_class_criteria','instrumentClassCriteria','varchar','input','32','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(4,'campaign_name_criteria','campaignNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(5,'experiment_name_criteria','experimentNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(6,'instrument_name_criteria','instrumentNameCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(7,'instrument_excl_criteria','instrumentExclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(8,'organism_name_criteria','organismNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(9,'dataset_name_criteria','datasetNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(10,'exp_comment_criteria','experimentCommentCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(11,'labelling_incl_criteria','labellingInclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(12,'labelling_excl_criteria','labellingExclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(13,'analysis_tool_name','analysisToolName','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(14,'param_file_name','paramFileName','varchar','input','255','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(15,'settings_file_name','settingsFileName','varchar','input','255','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(16,'organism_name','organismName','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(17,'organism_db_name','organismDBName','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(18,'prot_coll_name_list','protCollNameList','varchar','input','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(19,'prot_coll_options_list','protCollOptionsList','varchar','input','256','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(20,'priority','priority','int','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(21,'enabled','enabled','tinyint','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(22,'description','description','varchar','input','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(23,'creator','creator','varchar','input','50','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(24,'next_level','nextLevel','varchar','input','12','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(25,'id','id','int','output','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(26,'<local>','mode','varchar','input','12','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(27,'<local>','message','varchar','output','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(28,'separation_type_criteria','separationTypeCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(29,'campaign_excl_criteria','campaignExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(30,'experiment_excl_criteria','experimentExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(31,'dataset_excl_criteria','datasetExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(32,'dataset_type_criteria','datasetTypeCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(33,'trigger_before_disposition','TriggerBeforeDisposition','tinyint','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(34,'propagation_mode','PropagationMode','varchar','input','24','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(35,'special_processing','specialProcessing','varchar','input','512','add_update_predefined_analysis');

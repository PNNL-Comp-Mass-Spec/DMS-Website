...
INSERT INTO general_params VALUES('entry_sproc','add_update_predefined_analysis');
...
INSERT INTO form_fields VALUES(8,'instrument_name_criteria','Instrument Criteria','text','60','64','','','','trim|max_length[64]');
INSERT INTO form_fields VALUES(9,'instrument_excl_criteria','Instrument Exclusion Criteria','text','60','64','','','','trim|max_length[64]');
INSERT INTO form_fields VALUES(10,'organism_name_criteria','Organism Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(11,'campaign_name_criteria','Campaign Criteria','text','60','128','','','','trim');
INSERT INTO form_fields VALUES(12,'campaign_excl_criteria','Campaign Exclusion Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(13,'experiment_name_criteria','Experiment Criteria','text','60','128','','','','trim');
INSERT INTO form_fields VALUES(14,'experiment_excl_criteria','Experiment Exclusion Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(15,'exp_comment_criteria','Experiment Comment Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(16,'dataset_name_criteria','Dataset Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(17,'dataset_excl_criteria','Dataset Exclusion Criteria','text','60','128','','','','trim|max_length[128]');
INSERT INTO form_fields VALUES(18,'dataset_type_criteria','Dataset Type Criteria','text','50','64','','','','trim|max_length[64]');
INSERT INTO form_fields VALUES(19,'scan_type_criteria','Scan Type Criteria','text','50','64','','','','trim|max_length[64]');
INSERT INTO form_fields VALUES(20,'scan_type_excl_criteria','Scan Type Exclusion Criteria','text','50','64','','','','trim|max_length[64]');
INSERT INTO form_fields VALUES(21,'labelling_incl_criteria','Experiment Labelling Criteria','text','60','64','','','','trim');
...
INSERT INTO form_field_options VALUES(2,'organism_name_criteria','section','Evaluation Criteria');
...
INSERT INTO sproc_args VALUES(1,'level','level','int','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(2,'sequence','sequence','varchar','input','12','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(3,'next_level','nextLevel','varchar','input','12','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(4,'trigger_before_disposition','TriggerBeforeDisposition','tinyint','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(5,'propagation_mode','PropagationMode','varchar','input','24','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(6,'instrument_class_criteria','instrumentClassCriteria','varchar','input','32','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(7,'instrument_name_criteria','instrumentNameCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(8,'instrument_excl_criteria','instrumentExclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(9,'campaign_name_criteria','campaignNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(10,'campaign_excl_criteria','campaignExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(11,'experiment_name_criteria','experimentNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(12,'experiment_excl_criteria','experimentExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(13,'exp_comment_criteria','experimentCommentCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(14,'organism_name_criteria','organismNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(15,'dataset_name_criteria','datasetNameCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(16,'dataset_excl_criteria','datasetExclCriteria','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(17,'dataset_type_criteria','datasetTypeCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(18,'scan_type_criteria','scanTypeCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(19,'scan_type_excl_criteria','scanTypeExclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(20,'labelling_incl_criteria','labellingInclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(21,'labelling_excl_criteria','labellingExclCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(22,'separation_type_criteria','separationTypeCriteria','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(23,'analysis_tool_name','analysisToolName','varchar','input','64','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(24,'param_file_name','paramFileName','varchar','input','255','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(25,'settings_file_name','settingsFileName','varchar','input','255','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(26,'organism_name','organismName','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(27,'organism_db_name','organismDBName','varchar','input','128','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(28,'prot_coll_name_list','protCollNameList','varchar','input','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(29,'prot_coll_options_list','protCollOptionsList','varchar','input','256','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(30,'priority','priority','int','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(31,'enabled','enabled','tinyint','input','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(32,'description','description','varchar','input','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(33,'special_processing','specialProcessing','varchar','input','512','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(34,'creator','creator','varchar','input','50','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(35,'id','id','int','output','','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(36,'<local>','mode','varchar','input','12','add_update_predefined_analysis');
INSERT INTO sproc_args VALUES(37,'<local>','message','varchar','output','512','add_update_predefined_analysis');
CREATE TABLE detail_report_hotlinks ( idx INTEGER PRIMARY KEY,  "name" text, "LinkType" text, "WhichArg" text, "Target" text, "Placement" text, "id" text , options text);
INSERT INTO detail_report_hotlinks VALUES(1,'settings_file_name','detail-report','settings_file_name','settings_files/report/-/~','labelCol','dl_settings_file','');
INSERT INTO detail_report_hotlinks VALUES(2,'instrument_class_criteria','detail-report','instrument_class_criteria','instrument_class/show','labelCol','dl_instrument_class','');

...
INSERT INTO general_params VALUES('list_report_data_cols','id, name, requests, req_priority, instrument, description, owner, created, comment');
...
INSERT INTO list_report_primary_filter VALUES(1,'pf_id','ID','8!','','id','Equals','text','20','','');
INSERT INTO list_report_primary_filter VALUES(2,'pf_name','Name','25!','','name','ContainsText','text','50','','');

...
INSERT INTO "form_fields" VALUES(15,'Batch','Batch','text','15','24','','','','trim|max_length[24]');
...
INSERT INTO "form_fields" VALUES(18,'RR_WorkPackage','Work Package','text','15','50','','','(lookup)','trim|max_length[50]|required');
INSERT INTO "form_fields" VALUES(19,'RR_EUSUsageType','EMSL Usage Type','text','15','50','','','(lookup)','trim|required|max_length[50]|not_contain[(unknown)]');
INSERT INTO "form_fields" VALUES(20,'RR_EUSProposalID','EMSL Proposal ID','text','10','10','','','(lookup)','trim|max_length[10]');
INSERT INTO "form_fields" VALUES(21,'RR_EUSUsers','EMSL Proposal User','text','25','1024','','','(lookup)','trim|max_length[1024]');
INSERT INTO "form_fields" VALUES(22,'MRMAttachment','MRM Transition List Attachment','text','60','128','','','','trim|max_length[128]');
INSERT INTO "form_fields" VALUES(23,'RR_Internal_Standard','Dataset Internal Standard','hidden','','','','','none','trim|max_length[50]');
INSERT INTO "form_fields" VALUES(24,'RR_Status','Status','text','24','24','','','Active','trim|max_length[24]');
...
INSERT INTO "sproc_args" VALUES(12,'Batch','batch','int','input','','AddUpdateRequestedRun');
...
INSERT INTO "sproc_args" VALUES(15,'RR_EUSProposalID','eusProposalID','varchar','input','10','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(16,'RR_EUSUsageType','eusUsageType','varchar','input','50','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(17,'RR_EUSUsers','eusUsersList','varchar','input','1024','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(18,'RR_Status','status','varchar','input','24','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(19,'<local>','mode','varchar','input','12','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(20,'RR_Request','request','int','output','','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(21,'<local>','message','varchar','output','1024','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(22,'RR_SecSep','secSep','varchar','input','64','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(23,'MRMAttachment','MRMAttachment','varchar','input','128','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(24,'<local>','callingUser','varchar','input','128','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(25,'RR_VialingConc','VialingConc','varchar','input','32','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(26,'RR_VialingVol','VialingVol','varchar','input','32','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(27,'StagingLocation','stagingLocation','varchar','input','64','AddUpdateRequestedRun');
INSERT INTO "sproc_args" VALUES(28,'RR_Request','requestIDForUpdate','int','input','','AddUpdateRequestedRun');

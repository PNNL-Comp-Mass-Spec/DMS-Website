...
INSERT INTO list_report_primary_filter VALUES(2,'pf_dataset','Dataset','20','','dataset','ContainsTextTPO','text','128','','');
INSERT INTO list_report_primary_filter VALUES(3,'pf_result_type','Result Type','20','','result_type','ContainsText','text','64','','');
INSERT INTO list_report_primary_filter VALUES(4,'pf_peptide_db_name','Peptide DB_Name','20','','peptide_db_name','ContainsText','text','128','','');
...
INSERT INTO list_report_primary_filter VALUES(8,'pf_server_name','Server Name','20','','server_name','ContainsText','text','128','','');

...
INSERT INTO sproc_args VALUES(1,'i_name','instrumentName','varchar','input','24','add_new_instrument');
INSERT INTO sproc_args VALUES(2,'i_class','instrumentClass','varchar','input','32','add_new_instrument');
INSERT INTO sproc_args VALUES(3,'i_method','captureMethod','varchar','input','10','add_new_instrument');
INSERT INTO sproc_args VALUES(4,'i_room_num','roomNumber','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(5,'i_description','description','varchar','input','255','add_new_instrument');
INSERT INTO sproc_args VALUES(6,'source_machine_name','sourceMachineName','varchar','input','128','add_new_instrument');
INSERT INTO sproc_args VALUES(7,'source_path','sourcePath','varchar','input','255','add_new_instrument');
INSERT INTO sproc_args VALUES(8,'path','spPath','varchar','input','255','add_new_instrument');
INSERT INTO sproc_args VALUES(9,'vol_client','spVolClient','varchar','input','128','add_new_instrument');
INSERT INTO sproc_args VALUES(10,'vol_server','spVolServer','varchar','input','128','add_new_instrument');
INSERT INTO sproc_args VALUES(11,'archive_path','archivePath','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(12,'archive_server','archiveServer','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(13,'archive_note','archiveNote','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(14,'usage','Usage','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(15,'operations_role','OperationsRole','varchar','input','50','add_new_instrument');
INSERT INTO sproc_args VALUES(16,'instrument_group','InstrumentGroup','varchar','input','64','add_new_instrument');
INSERT INTO sproc_args VALUES(17,'percent_emsl_owned','PercentEMSLOwned','varchar','input','24','add_new_instrument');
INSERT INTO sproc_args VALUES(18,'<local>','message','varchar','output','512','add_new_instrument');
INSERT INTO sproc_args VALUES(19,'auto_define_storage_path','AutoDefineStoragePath','varchar','input','32','add_new_instrument');
COMMIT;

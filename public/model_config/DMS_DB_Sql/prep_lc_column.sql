...
INSERT INTO general_params VALUES('entry_page_data_id_col','prep_column');
INSERT INTO general_params VALUES('entry_sproc','AddUpdatePrepLCColumn');
INSERT INTO general_params VALUES('post_submission_detail_id','prep_column');
INSERT INTO general_params VALUES('list_report_data_sort_col','created');
INSERT INTO general_params VALUES('list_report_data_sort_dir','DESC');
CREATE TABLE form_fields ( id INTEGER PRIMARY KEY, "name"  text, "label" text, "type" text, "size" text, "maxlength" text, "rows" text, "cols" text, "default" text, "rules" text);
INSERT INTO form_fields VALUES(1,'prep_column','Column Name','text-if-new','50','128','','','','trim|max_length[128]|alpha_dash|min_length[8]');
...
INSERT INTO form_fields VALUES(4,'mfg_serial','Mfg Serial Number','text','50','64','','','','trim|max_length[64]');
...
INSERT INTO sproc_args VALUES(1,'prep_column','ColumnName','varchar','input','128','AddUpdatePrepLCColumn');
...
INSERT INTO sproc_args VALUES(4,'mfg_serial','MfgSerialNumber','varchar','input','64','AddUpdatePrepLCColumn');

...
INSERT INTO "sproc_args" VALUES(9,'organismName','organismName','varchar','input','50','AddUpdateExperiment');
...
INSERT INTO "sproc_args" VALUES(14,'labNotebookRef','labNotebookRef','varchar','input','64','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(15,'labelling','labelling','varchar','input','64','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(16,'cellCultureList','cellCultureList','varchar','input','512','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(17,'referenceCompoundList','referenceCompoundList','varchar','input','512','AddUpdateExperiment');
...
INSERT INTO "form_fields" VALUES(4,'researcherPRN','Researcher (PRN)','text','40','80','','','','trim|required|max_length[32]');
INSERT INTO "form_fields" VALUES(5,'organismName','Organism Name','text','40','80','','','','trim|required|max_length[50]');
...
INSERT INTO "form_fields" VALUES(10,'sampleConcentration','Smpl. Concentration','text','40','80','','','','trim|required|max_length[24]');
INSERT INTO "form_fields" VALUES(11,'enzymeName','Digestion Enzyme','text','40','50','','','Trypsin','trim|required|max_length[50]');
INSERT INTO "form_fields" VALUES(12,'labNotebookRef','Lab Notebook','text','40','80','','','','trim|required|max_length[50]');

...
INSERT INTO general_params VALUES('entry_sproc','add_update_experiment');
...
INSERT INTO list_report_primary_filter VALUES(2,'pf_experiment','Experiment','40!','','experiment','ContainsTextTPO','text','128','','');
...
INSERT INTO sproc_args VALUES(3,'<local>','message','varchar','output','512','do_material_item_operation');
INSERT INTO sproc_args VALUES(4,'<local>','callingUser','varchar','input','128','do_material_item_operation');
INSERT INTO sproc_args VALUES(5,'id','experimentId','int','output','','add_update_experiment');
INSERT INTO sproc_args VALUES(6,'experiment','experimentName','varchar','input','50','add_update_experiment');
INSERT INTO sproc_args VALUES(7,'campaign','campaignName','varchar','input','64','add_update_experiment');
INSERT INTO sproc_args VALUES(8,'researcher_username','researcherUsername','varchar','input','50','add_update_experiment');
INSERT INTO sproc_args VALUES(9,'organism_name','organismName','varchar','input','128','add_update_experiment');
INSERT INTO sproc_args VALUES(10,'reason','reason','varchar','input','500','add_update_experiment');
INSERT INTO sproc_args VALUES(11,'comment','comment','varchar','input','500','add_update_experiment');
INSERT INTO sproc_args VALUES(12,'sample_concentration','sampleConcentration','varchar','input','32','add_update_experiment');
INSERT INTO sproc_args VALUES(13,'enzyme_name','enzymeName','varchar','input','50','add_update_experiment');
INSERT INTO sproc_args VALUES(14,'lab_notebook_ref','labNotebookRef','varchar','input','128','add_update_experiment');
INSERT INTO sproc_args VALUES(15,'labelling','labelling','varchar','input','64','add_update_experiment');
INSERT INTO sproc_args VALUES(16,'biomaterial_list','biomaterialList','varchar','input','2048','add_update_experiment');
INSERT INTO sproc_args VALUES(17,'reference_compound_list','referenceCompoundList','varchar','input','2048','add_update_experiment');
INSERT INTO sproc_args VALUES(18,'sample_prep_request','samplePrepRequest','int','input','','add_update_experiment');
INSERT INTO sproc_args VALUES(19,'internal_standard','internalStandard','varchar','input','50','add_update_experiment');
INSERT INTO sproc_args VALUES(20,'postdigest_int_std','postdigestIntStd','varchar','input','50','add_update_experiment');
INSERT INTO sproc_args VALUES(21,'wellplate','wellplateName','varchar','input','64','add_update_experiment');
INSERT INTO sproc_args VALUES(22,'well','wellNumber','varchar','input','8','add_update_experiment');
INSERT INTO sproc_args VALUES(23,'alkylation','alkylation','varchar','input','1','add_update_experiment');
INSERT INTO sproc_args VALUES(24,'<local>','mode','varchar','input','12','add_update_experiment');
INSERT INTO sproc_args VALUES(25,'<local>','message','varchar','output','512','add_update_experiment');
INSERT INTO sproc_args VALUES(26,'container','container','varchar','input','128','add_update_experiment');
INSERT INTO sproc_args VALUES(27,'barcode','barcode','varchar','input','64','add_update_experiment');
INSERT INTO sproc_args VALUES(28,'tissue','tissue','varchar','intput','128','add_update_experiment');
INSERT INTO sproc_args VALUES(29,'<local>','callingUser','varchar','input','128','add_update_experiment');

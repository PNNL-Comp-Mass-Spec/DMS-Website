...
INSERT INTO chooser_definitions VALUES(7,'datasetRatingPickList','default','select','{"Unreviewed":"Unreviewed", "Released":"Released", "Not Released":"Not Released (not service center eligible)", "Rerun (Good Data)":"Rerun (Good data, not service center eligible)", "Rerun (Superseded)":"Rerun (Superseded, not service center eligible)", "Exclude From Service Center":"Exclude From Service Center", "Method Development":"Method Development (not service center eligible)" }');
...
INSERT INTO chooser_definitions VALUES(26,'samplePrepReqMethodPickList','default','select','{"Bond Elut PPL (ICR) ":"Bond Elut PPL (ICR)", "Cysteinyl-peptide enrichment":"Cysteinyl-peptide enrichment", "Dilute for analysis":"Dilute for analysis", "FASP":"FASP", "GC-MS chemical derivatization":"GC-MS chemical derivatization", "Gel Electrophoresis":"Gel Electrophoresis", "Global Digest":"Global Digest", "High pH fractionation":"High pH fractionation", "HPLC Depletion":"HPLC Depletion", "iTRAQ labeling":"iTRAQ labeling", "MALDI":"MALDI", "Modified Folch (ICR)":"Modified Folch (ICR)", "MPLEx":"MPLEx", "N-glycopeptide enrichment":"N-glycopeptide enrichment", "Online 2D SCX fractionation":"Online 2D SCX fractionation", "Phosphopeptide enrichment":"Phosphopeptide enrichment", "SEER":"SEER", "Sequential Extraction (ICR)":"Sequential Extraction (ICR)", "Solvent Extraction":"Solvent Extraction", "SPE Cleanup":"SPE Cleanup", "TFE Digest":"TFE Digest", "TMT Labeling":"TMT Labeling", "Water/NaOH (ICR)":"Water/NaOH (ICR)", "Other":"Other"}');
...
INSERT INTO chooser_definitions VALUES(54,'filterSetPickList','default','sql','SELECT distinct CONCAT(CAST(filter_set_ID as varchar(11)), '' - '', Filter_Set_Name) as val, filter_set_ID as ex FROM V_Filter_Sets ORDER by filter_set_ID');
...
INSERT INTO chooser_definitions VALUES(58,'instrumentNamePickList','default','sql','SELECT val, ex, operations_role FROM V_Instrument_Picklist WHERE NOT operations_role IN (''LC'', ''Offsite'') ORDER BY val;');
...
INSERT INTO chooser_definitions VALUES(99,'longIntervalUsagePickList','default','select','{ "UserOnsite[100%], Proposal[xxx], PropUser[xxx]":"UserOnsite, Proposal, PropUser", "UserRemote[100%], Proposal[xxx], PropUser[xxx]":"UserRemote, Proposal, PropUser", "Broken[100%]":"Broken", "Maintenance[100%]":"Maintenance", "OtherNotAvailable[100%]":"OtherNotAvailable", "CapDev[100%], Operator[xxx]":"CapDev, Operator", "ResourceOwner[100%], Operator[xxx]":"ResourceOwner, Operator", "StaffNotAvailable[100%]":"StaffNotAvailable", "InstrumentAvailable[100%]":"InstrumentAvailable" }');
...
INSERT INTO chooser_definitions VALUES(142,'serviceTypePickList','default','sql','SELECT service_type_with_id as val, service_type_id as ex FROM V_Service_Type_Picklist ORDER BY service_type_id;');
COMMIT;

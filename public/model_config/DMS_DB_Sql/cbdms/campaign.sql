...
INSERT INTO "form_fields" VALUES(6,'progmgr_prn','Project Manager','text','50','64','','','','trim|required|max_length[64]');
...
INSERT INTO "form_fields" VALUES(16,'eusproposal_list','EUSProposal List','area','','','1','70','','trim|max_length[256]');
INSERT INTO "form_fields" VALUES(17,'fraction_emsl_funded','Fraction EMSL Funded','text','24','24','','','','trim|max_length[24]');
INSERT INTO "form_fields" VALUES(18,'eususage_type','EUS Usage Type','text','','','','','USER_ONSITE','trim|max_length[50]');
...
INSERT INTO "form_field_options" VALUES(1,'progmgr_prn','default_function','GetUser()');
INSERT INTO "form_field_options" VALUES(2,'campaign','section','General');
INSERT INTO "form_field_options" VALUES(3,'progmgr_prn','section','Team Membership');
...
INSERT INTO "form_field_choosers" VALUES(1,'progmgr_prn','picker.replace','userPRNPickList','','',',','');
...
INSERT INTO "form_field_choosers" VALUES(5,'eusproposal_list','list-report.helper','','helper_eus_proposal_ckbx/report','',',','');
INSERT INTO "form_field_choosers" VALUES(7,'organisms','list-report.helper','','helper_organism_ckbx/report','',',','');
INSERT INTO "form_field_choosers" VALUES(8,'sample_preparation_staff','picker.append','userPRNPickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(9,'dataset_acquisition_staff','picker.append','userPRNPickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(10,'informatics_staff','picker.append','userPRNPickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(11,'data_release_restrictions','picker.replace','dataReleaseRestrictionsPicklist','','',',','');
INSERT INTO "form_field_choosers" VALUES(12,'eususage_type','picker.replace','campaignEusUsageTypePickList','','',',','');
...
INSERT INTO "sproc_args" VALUES(3,'progmgr_prn','progmgrPRN','varchar','input','64','AddUpdateCampaign');
...
INSERT INTO "sproc_args" VALUES(15,'eusproposal_list','eusProposalList','varchar','input','256','AddUpdateCampaign');
...
INSERT INTO "sproc_args" VALUES(20,'eususage_type','eusUsageType','varchar','input','50','AddUpdateCampaign');

...
INSERT INTO general_params VALUES('detail_report_data_cols','campaign, state, data_release_restriction, description, comment, team_members, collaborators, id, created, most_recent_activity, biomaterial, most_recent_biomaterial, experiments, most_recent_experiment, run_requests, most_recent_run_request, datasets, most_recent_dataset, analysis_jobs, most_recent_analysis_job, data_packages');

...
INSERT INTO "sproc_args" VALUES(3,'categoryName','categoryName','varchar','input','128','AddUpdateAuxInfo');
INSERT INTO "sproc_args" VALUES(4,'subCategoryName','subCategoryName','varchar','input','128','AddUpdateAuxInfo');
INSERT INTO "sproc_args" VALUES(5,'itemNameList','itemNameList','varchar','input','4000','AddUpdateAuxInfo');
INSERT INTO "sproc_args" VALUES(6,'itemValueList','itemValueList','varchar','input','3000','AddUpdateAuxInfo');
...
INSERT INTO "utility_queries" VALUES(8,'aux_info_items','(internal)','','T_AuxInfo_Description','*','{"col":"Sequence", "dir":"ASC"}','{"Parent_ID":"EQn"}','');
INSERT INTO "utility_queries" VALUES(9,'aux_info_allowed_values','(internal)','','T_AuxInfo_Allowed_Values','Value as ID, Value as Name','{"col":"Value", "dir":"ASC"}','{"AuxInfoID":"EQn"}','');
COMMIT;

...
INSERT INTO general_params VALUES('detail_report_data_cols','dataset, experiment, organism, experiment tissue, instrument, separation_type, lc_cart, lc_column, type, operator, comment, rating, state, id, created, request, dataset_folder_path, data_folder_link, qc_link, qc_2d, masic_qc_link, qc_metric_stats, jobs, psm_jobs, factors, predefines_triggered, acquisition_start, acquisition_end, run_start, run_finish, scan_count, scan_types, acq_length, file_size_mb, file_info_updated, dataset_file, sha1_hash, folder_name, capture_subfolder');

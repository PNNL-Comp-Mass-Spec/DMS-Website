...
INSERT INTO "form_fields" VALUES(8,'cellCultureList','Biomaterial (Cell Culture)','area','','','2','40','','trim|max_length[2048]');
INSERT INTO "form_fields" VALUES(9,'referenceCompoundList','Reference Compounds','area','','','3','60','','trim|max_length[2048]');
INSERT INTO "form_fields" VALUES(10,'sampleConcentration','Smpl. Concentration','text','40','80','','','','trim|required|max_length[32]');
INSERT INTO "form_fields" VALUES(11,'enzymeName','Digestion Enzyme','text','40','50','','','Trypsin','trim|required|max_length[50]');
INSERT INTO "form_fields" VALUES(12,'labNotebookRef','Lab Notebook','text','40','80','','','','trim|required|max_length[128]');
...
INSERT INTO "form_fields" VALUES(15,'internalStandard','Predigest Int Std','text','50','50','','','none','trim|max_length[50]');
INSERT INTO "form_fields" VALUES(16,'postdigestIntStd','Postdigest Int Std','text','50','50','','','none','trim|max_length[50]');
INSERT INTO "form_fields" VALUES(17,'alkylation','Alkylation','text','1','1','','','N','trim|max_length[1]');
INSERT INTO "form_fields" VALUES(18,'samplePrepRequest','Sample Prep Request','text','4','4','','','0','trim');
...
INSERT INTO "form_fields" VALUES(21,'wellNum','Well Number','text','8','8','','','','trim|max_length[8]');
...
INSERT INTO "sproc_args" VALUES(8,'researcherPRN','researcherPRN','varchar','input','50','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(9,'organismName','organismName','varchar','input','128','AddUpdateExperiment');
...
INSERT INTO "sproc_args" VALUES(12,'sampleConcentration','sampleConcentration','varchar','input','32','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(13,'enzymeName','enzymeName','varchar','input','50','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(14,'labNotebookRef','labNotebookRef','varchar','input','128','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(15,'labelling','labelling','varchar','input','64','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(16,'cellCultureList','cellCultureList','varchar','input','2048','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(17,'referenceCompoundList','referenceCompoundList','varchar','input','2048','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(18,'samplePrepRequest','samplePrepRequest','int','input','','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(19,'internalStandard','internalStandard','varchar','input','50','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(20,'postdigestIntStd','postdigestIntStd','varchar','input','50','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(21,'Wellplate','wellplateName','varchar','input','64','AddUpdateExperiment');
INSERT INTO "sproc_args" VALUES(22,'wellNum','wellNum','varchar','input','8','AddUpdateExperiment');

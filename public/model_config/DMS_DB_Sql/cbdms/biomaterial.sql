...
INSERT INTO general_params VALUES('entry_sproc','add_update_biomaterial');
...
INSERT INTO general_params VALUES('list_report_data_cols','id, name, source, contact, type, created, pi, comment, campaign, organisms, material_status');
INSERT INTO general_params VALUES('detail_report_data_cols','name, supplier, contact_usually_pnnl_staff, type, comment, campaign, id, organism_list');
...
INSERT INTO sproc_args VALUES(1,'name','biomaterialName','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(2,'source_name','sourceName','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(3,'contact_username','contactUsername','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(4,'pi_username','piUsername','varchar','input','32','add_update_biomaterial');
INSERT INTO sproc_args VALUES(5,'biomaterial_type_name','biomaterialType','varchar','input','32','add_update_biomaterial');
INSERT INTO sproc_args VALUES(6,'reason','reason','varchar','input','500','add_update_biomaterial');
INSERT INTO sproc_args VALUES(7,'comment','comment','varchar','input','500','add_update_biomaterial');
INSERT INTO sproc_args VALUES(8,'campaign','campaignName','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(9,'<local>','mode','varchar','input','12','add_update_biomaterial');
INSERT INTO sproc_args VALUES(10,'<local>','message','varchar','output','512','add_update_biomaterial');
INSERT INTO sproc_args VALUES(11,'container','container','varchar','input','128','add_update_biomaterial');
INSERT INTO sproc_args VALUES(12,'organism_list','organismList','varchar','input','8000','add_update_biomaterial');
INSERT INTO sproc_args VALUES(13,'mutation','mutation','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(14,'plasmid','plasmid','varchar','input','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(15,'cell_line','cellLine','varchar','varchar','64','add_update_biomaterial');
INSERT INTO sproc_args VALUES(16,'id','name','varchar','input','128','do_material_item_operation');
INSERT INTO sproc_args VALUES(17,'<local>','callingUser','varchar','input','128','add_update_biomaterial');
INSERT INTO sproc_args VALUES(18,'<local>','mode','varchar','input','32','do_material_item_operation');
INSERT INTO sproc_args VALUES(19,'<local>','message','varchar','output','512','do_material_item_operation');
INSERT INTO sproc_args VALUES(20,'<local>','callingUser','varchar','input','128','do_material_item_operation');

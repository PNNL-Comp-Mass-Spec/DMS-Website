...
INSERT INTO general_params VALUES('detail_report_data_cols','id, name, package_type, description, comment, owner, requester, team, created, last_modified, state, package_file_folder, share_path, web_path, amt_tag_database, biomaterial_item_count, experiment_item_count, eus_proposals_count, dataset_item_count, analysis_job_item_count, campaign_count, total_item_count');
...
INSERT INTO detail_report_hotlinks VALUES(1,'share_path','href-folder','share_path','','valueCol','share_path',NULL);
INSERT INTO detail_report_hotlinks VALUES(2,'web_path','literal_link','web_path','','valueCol','web_path',NULL);
INSERT INTO detail_report_hotlinks VALUES(3,'biomaterial_item_count','detail-report','id','data_package_biomaterial/report','labelCol','biomaterial_item_count',NULL);
INSERT INTO detail_report_hotlinks VALUES(4,'experiment_item_count','detail-report','id','data_package_experiments/report','labelCol','experiment_item_count',NULL);
INSERT INTO detail_report_hotlinks VALUES(5,'+experiment_item_count','detail-report','id','data_package_experiment_plex_members/report','valueCol','experiment_item_count','');
INSERT INTO detail_report_hotlinks VALUES(6,'dataset_item_count','detail-report','id','data_package_dataset/report','labelCol','dataset_item_count',NULL);
INSERT INTO detail_report_hotlinks VALUES(7,'+dataset_item_count','detail-report','id','data_package_dataset_files/report','valueCol','dataset_item_count','');
INSERT INTO detail_report_hotlinks VALUES(8,'analysis_job_item_count','detail-report','id','data_package_analysis_jobs/report','labelCol','analysis_job_item_count',NULL);
INSERT INTO detail_report_hotlinks VALUES(9,'total_item_count','detail-report','id','data_package_items/report','labelCol','total_item_count',NULL);
INSERT INTO detail_report_hotlinks VALUES(10,'prism_wiki','literal_link','prism_wiki','','valueCol','prism_wiki',NULL);
...
INSERT INTO detail_report_hotlinks VALUES(13,'eus_proposals_count','detail-report','id','data_package_proposals/report','labelCol','eus_proposals_count','');
INSERT INTO detail_report_hotlinks VALUES(14,'eus_user_id','detail-report','eus_user_id','eus_users/show','labelCol','eus_user_id','');
INSERT INTO detail_report_hotlinks VALUES(15,'eus_proposal_id','detail-report','eus_proposal_id','eus_proposals/show','labelCol','eus_proposal_id','');
INSERT INTO detail_report_hotlinks VALUES(16,'data_doi','doi_link','data_doi','','valueCol','','');

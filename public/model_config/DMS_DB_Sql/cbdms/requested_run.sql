...
INSERT INTO general_params VALUES('list_report_data_cols','Request, Name, Status, Origin, Acq_Start, Campaign, Experiment, Dataset, Instrument, Requester, Created, [Days In Queue], Comment, Type, [Separation Group], [Vialing Conc], [Vialing Vol], Cart, [Dataset Comment], [Request Name Code], days_in_queue_bin');
INSERT INTO general_params VALUES('detail_report_data_cols','Request, Name, Status, Campaign, Experiment, Dataset, [Staging Location], [Instrument Used], [Instrument Group], Type, [Separation Group], Requester, Username, Created, [Days In Queue], Origin, [Instrument Settings], [Vialing Concentration], [Vialing Volume], Comment, Factors, Note, [Special Instructions], wp_activation_state');
...
INSERT INTO detail_report_hotlinks VALUES(12,'Work Package State','color_label','wp_activation_state','','valueCol','dl_Work_Package_State','{"3":"clr_90","4":"clr_120", "5":"clr_120","10":"clr_120"}');

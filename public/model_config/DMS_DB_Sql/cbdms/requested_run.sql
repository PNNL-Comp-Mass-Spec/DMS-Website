...
INSERT INTO general_params VALUES('list_report_data_cols','Request, Name, Status, Origin, Acq_Start, Campaign, Experiment, Dataset, Instrument, Requester, Created, [Days In Queue], Comment, Type, [Separation Group], [Vialing Conc], [Vialing Vol], Cart, [Dataset Comment], [Request Name Code], [#days_in_queue]');
...
INSERT INTO list_report_hotlinks VALUES(5,'Days In Queue','color_label','#days_in_queue','','{"30":"clr_30","60":"clr_60","90":"clr_90","120":"clr_120"}');

...
INSERT INTO "general_params" VALUES('list_report_data_cols','Request, Name, Status, Origin, Acq_Start, Campaign, Experiment, Dataset, Instrument, Requester, Created, [Days In Queue], Comment, Type, [Separation Group], [Vialing Conc], [Vialing Vol], Cart, [Dataset Comment], [Request Name Code], [#DaysInQueue]');

...
INSERT INTO "sproc_args" VALUES(2,'TaskTypeName','taskType','varchar','input','50','AddUpdateOperationsTasks');
...
INSERT INTO "sproc_args" VALUES(5,'RequestedPersonnel','requestedPersonnel','varchar','input','256','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(6,'AssignedPersonnel','assignedPersonnel','varchar','input','256','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(7,'Description','description','varchar','input','5132','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(8,'Comments','comments','varchar','input','2147483647','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(9,'LabName','labName','varchar','input','64','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(10,'Status','status','varchar','input','32','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(11,'Priority','priority','varchar','input','32','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(12,'WorkPackage','workPackage','varchar','input','32','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(14,'<local>','mode','varchar','input','12','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(15,'<local>','message','varchar','output','512','AddUpdateOperationsTasks');
INSERT INTO "sproc_args" VALUES(16,'<local>','callingUser','varchar','input','128','AddUpdateOperationsTasks');
CREATE TABLE form_fields ( id INTEGER PRIMARY KEY, "name"  text, "label" text, "type" text, "size" text, "maxlength" text, "rows" text, "cols" text, "default" text, "rules" text);
INSERT INTO "form_fields" VALUES(1,'ID','ID','non-edit','','','','','','trim');
INSERT INTO "form_fields" VALUES(2,'TaskTypeName','Task Type','text','32','50','','','','trim|max_length[50]');
...
INSERT INTO "form_fields" VALUES(6,'RequestedPersonnel','Requested Personnel','area','','','4','70','','trim|max_length[256]');
INSERT INTO "form_fields" VALUES(7,'AssignedPersonnel','Assigned Personnel','area','','','4','70','','trim|max_length[256]');
INSERT INTO "form_fields" VALUES(8,'Comments','Comments','area','','','4','70','','trim|max_length[2147483647]');
INSERT INTO "form_fields" VALUES(9,'LabName','Lab','text','50','64','','','','trim|max_length[64]');
...
INSERT INTO "form_fields" VALUES(12,'WorkPackage','Work Package','text','32','32','','','','trim|max_length[32]');
...
INSERT INTO "form_field_choosers" VALUES(3,'RequestedPersonnel','picker.replace','operationsTaskStaff','','',',','');
INSERT INTO "form_field_choosers" VALUES(4,'AssignedPersonnel','picker.append','operationsTaskStaff','','',',','');
INSERT INTO "form_field_choosers" VALUES(5,'Requester','picker.replace','userPRNPickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(6,'TaskTypeName','picker.replace','operationTaskTypePickList','','',',','');
INSERT INTO "form_field_choosers" VALUES(7,'LabName','picker.replace','labLocationPickList','','',',','');
COMMIT;

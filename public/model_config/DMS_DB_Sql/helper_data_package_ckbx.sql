...
INSERT INTO general_params VALUES('list_report_data_cols','id AS sel, id, name, description, owner, team, state, package_type, requester, total, jobs, datasets, proposals, experiments, biomaterial, last_modified, created');

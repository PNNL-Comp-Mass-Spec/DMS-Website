...
INSERT INTO general_params VALUES('entry_sproc','update_notification_user_registration');
...
INSERT INTO general_params VALUES('operations_sproc','update_research_team_observer');
...
INSERT INTO list_report_primary_filter VALUES(2,'pf_username','Username','20','','username','ContainsText','text','50','','');
...
INSERT INTO list_report_hotlinks VALUES(4,'person','invoke_entity','username','user/show','');
INSERT INTO list_report_hotlinks VALUES(5,'username','no_display','value','','');
INSERT INTO list_report_hotlinks VALUES(6,'entity_type','no_display','value','','');
CREATE TABLE sproc_args ( id INTEGER PRIMARY KEY, "field" text, "name" text, "type" text, "dir" text, "size" text, "procedure" text);
INSERT INTO sproc_args VALUES(1,'username','username','varchar','input','15','update_notification_user_registration');
INSERT INTO sproc_args VALUES(2,'name','Name','varchar','input','64','update_notification_user_registration');
INSERT INTO sproc_args VALUES(3,'requested_run_batch','RequestedRunBatch','varchar','input','4','update_notification_user_registration');
INSERT INTO sproc_args VALUES(4,'analysis_job_request','AnalysisJobRequest','varchar','input','4','update_notification_user_registration');
INSERT INTO sproc_args VALUES(5,'sample_prep_request','SamplePrepRequest','varchar','input','4','update_notification_user_registration');
INSERT INTO sproc_args VALUES(6,'dataset_not_released','DatasetNotReleased','varchar','input','4','update_notification_user_registration');
INSERT INTO sproc_args VALUES(7,'dataset_released','DatasetReleased','varchar','input','4','update_notification_user_registration');
INSERT INTO sproc_args VALUES(8,'<local>','mode','varchar','input','12','update_notification_user_registration');
INSERT INTO sproc_args VALUES(9,'<local>','message','varchar','output','512','update_notification_user_registration');
INSERT INTO sproc_args VALUES(10,'<local>','callingUser','varchar','input','128','update_notification_user_registration');
INSERT INTO sproc_args VALUES(11,'id','campaignName','varchar','input','64','update_research_team_observer');
INSERT INTO sproc_args VALUES(12,'<local>','mode','varchar','input','12','update_research_team_observer');
INSERT INTO sproc_args VALUES(13,'<local>','message','varchar','output','512','update_research_team_observer');
INSERT INTO sproc_args VALUES(14,'<local>','callingUser','varchar','input','128','update_research_team_observer');
CREATE TABLE form_fields ( id INTEGER PRIMARY KEY, "name"  text, "label" text, "type" text, "size" text, "maxlength" text, "rows" text, "cols" text, "default" text, "rules" text);
INSERT INTO form_fields VALUES(1,'username','Username','non-edit','15','15','','','','trim|max_length[15]');

...
INSERT INTO form_fields VALUES(12,'capture_method','Capture Method','text','10','10','','','fso','trim');
INSERT INTO form_fields VALUES(13,'auto_define_storage_path','Auto Define Storage Path','text','32','32','','','Y','trim|required|max_length[12]');
...
INSERT INTO form_fields VALUES(22,'track_usage_when_inactive','Track Usage When Inactive','text','32','32','','','Y','trim|required|max_length[12]');
...
INSERT INTO sproc_args VALUES(14,'auto_define_storage_path','autoDefineStoragePath','varchar','input','32','add_update_instrument');
INSERT INTO sproc_args VALUES(15,'auto_sp_vol_name_client','autoSPVolNameClient','varchar','input','128','add_update_instrument');
INSERT INTO sproc_args VALUES(16,'auto_sp_vol_name_server','autoSPVolNameServer','varchar','input','128','add_update_instrument');
INSERT INTO sproc_args VALUES(17,'auto_sp_path_root','autoSPPathRoot','varchar','input','128','add_update_instrument');
INSERT INTO sproc_args VALUES(18,'auto_sp_url_domain','autoSPUrlDomain','varchar','input','64','add_update_instrument');
INSERT INTO sproc_args VALUES(19,'auto_sp_archive_server_name','autoSPArchiveServerName','varchar','input','64','add_update_instrument');
INSERT INTO sproc_args VALUES(20,'auto_sp_archive_path_root','autoSPArchivePathRoot','varchar','input','128','add_update_instrument');
INSERT INTO sproc_args VALUES(21,'auto_sp_archive_share_path_root','autoSPArchiveSharePathRoot','varchar','input','128','add_update_instrument');
INSERT INTO sproc_args VALUES(22,'<local>','mode','varchar','input','12','add_update_instrument');
INSERT INTO sproc_args VALUES(23,'<local>','message','varchar','output','512','add_update_instrument');

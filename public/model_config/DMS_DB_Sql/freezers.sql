...
INSERT INTO list_report_primary_filter VALUES(1,'pf_Freezer','Freezer','25!','','freezer','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(2,'pf_Freezer_Tag','Freezer Tag','25!','','freezer_tag','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(3,'pf_Comment','Comment','15!','','comment','ContainsText','text','128','','');
INSERT INTO list_report_primary_filter VALUES(4,'pf_Status','Status','','','status','StartsWithText','text','32','','');

...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS 'table_edit_col_defs' (id INTEGER PRIMARY KEY,  "config_table" text, "config_col" text, "type" text, "value" text );
...
INSERT INTO table_edit_col_defs VALUES(13,'list_report_primary_filter','cmp','literal_list','{"list":["ContainsText", "ContainsTextTPO", "DoesNotContainText", "EarlierThan", "Equals", "GreaterThan", "GreaterThanOrEqualTo", "LaterThan", "LessThan", "LessThanOrEqualTo", "MatchesText", "MatchesTextOrBlank", "MostRecentWeeks", "NotEqual", "StartsWithText", "StartsWithTextTPO"]}');
...
INSERT INTO table_edit_col_defs VALUES(23,'external_sources','type','literal_list',replace('{"list":["ColName", "PostName",  "Literal" ]}\n','\n',char(10)));

...
INSERT INTO list_report_primary_filter VALUES(10,'pf_settings_file','Settings File','40!','','settings_file','ContainsTextTPO','text','128','','');
INSERT INTO list_report_primary_filter VALUES(11,'pf_job_request','Job Request','8!','','job_request','Equals','text','128','','');
...
INSERT INTO detail_report_hotlinks VALUES(7,'+request','detail-report','request','analysis_request_jobs/report','valueCol','dl_job_request_jobs','{"HideLinkIfValueMatch":"1"}');
INSERT INTO detail_report_hotlinks VALUES(8,'state','detail-report','job','pipeline_job_steps/report','labelCol','state','');
INSERT INTO detail_report_hotlinks VALUES(9,'tool_name','detail-report','tool_name','pipeline_script/report/~','labelCol','tool_name',NULL);
INSERT INTO detail_report_hotlinks VALUES(10,'settings_file','detail-report','settings_file','settings_files/report/-/~','labelCol','settings_file',NULL);
INSERT INTO detail_report_hotlinks VALUES(11,'mts_pt_db_count','detail-report','job','mts_pt_db_jobs/report','labelCol','PT_DBs','');
INSERT INTO detail_report_hotlinks VALUES(12,'mts_mt_db_count','detail-report','job','mts_mt_db_jobs/report','labelCol','MT_DBs','');
INSERT INTO detail_report_hotlinks VALUES(13,'peak_matching_results','detail-report','job','mts_pm_results/report/-/','labelCol','pmresults','');
INSERT INTO detail_report_hotlinks VALUES(16,'data_folder_link','literal_link','data_folder_link','','valueCol','dl_data_folder',NULL);
INSERT INTO detail_report_hotlinks VALUES(17,'job','detail-report','job','pipeline_jobs_history/show','labelCol','pipeline_job_detail_history','');
INSERT INTO detail_report_hotlinks VALUES(18,'+job','detail-report','job','pipeline_jobs/show','valueCol','pipeline_job_detail','');
INSERT INTO detail_report_hotlinks VALUES(19,'owner','detail-report','owner','user/show','labelCol','owner',NULL);
...
INSERT INTO detail_report_hotlinks VALUES(21,'psm_stats','detail-report','dataset','analysis_job_psm/report/-/-/-/~','labelCol','dl_analysis_job_psm',NULL);
INSERT INTO detail_report_hotlinks VALUES(22,'protein_collection_list','link_table','protein_collection_list','protein_collection/report/~','valueCol','dl_protein_collection','');
INSERT INTO detail_report_hotlinks VALUES(23,'param_file','detail-report','param_file','param_file/report/-/~@','labelCol','dl_param_file','');
INSERT INTO detail_report_hotlinks VALUES(24,'organism','detail-report','organism','organism/report/~','labelCol','dl_organism','');
INSERT INTO detail_report_hotlinks VALUES(25,'organism_db','detail-report','organism_db','helper_organism_db/report/~','labelCol','dl_organism_db','');

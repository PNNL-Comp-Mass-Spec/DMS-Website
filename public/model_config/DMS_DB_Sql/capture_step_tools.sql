...
INSERT INTO sproc_args VALUES(2,'description','Description','varchar','input','512','add_update_step_tools');
INSERT INTO sproc_args VALUES(3,'bionet_required','BionetRequired','char','input','1','add_update_step_tools');
INSERT INTO sproc_args VALUES(4,'only_on_storage_server','OnlyOnStorageServer','char','input','1','add_update_step_tools');
INSERT INTO sproc_args VALUES(5,'instrument_capacity_limited','InstrumentCapacityLimited','char','input','1','add_update_step_tools');
INSERT INTO sproc_args VALUES(6,'<local>','mode','varchar','input','12','add_update_step_tools');
INSERT INTO sproc_args VALUES(7,'<local>','message','varchar','output','512','add_update_step_tools');
INSERT INTO sproc_args VALUES(8,'<local>','callingUser','varchar','input','128','add_update_step_tools');
COMMIT;

...
For more information, see https://github.com/PNNL-Comp-Mass-Spec/DMS-Website/tree/master/public/model_config/DMS_DB_Cmp
...
* https://dms2.pnl.gov/config_db/show_db/ad_hoc_query.db
** Expand the utility_queries section
* http://dms2.pnl.gov/data/lr_menu (old)


To edit the ad-hoc reports, click the "Config db" link or go to:
* https://dmsdev.pnl.gov/config_db/show_db/ad_hoc_query.db
* Click "edit" in the utility_queries section
** Takes you to https://dmsdev.pnl.gov/config_db/edit_table/ad_hoc_query.db/utility_queries
